...
$_lang['setting_zoomx_default_tpl'] = 'Default template';
$_lang['setting_zoomx_default_tpl_desc'] = 'It\'s used when the router works in the strict mode and no route is found and the error page not found.';
