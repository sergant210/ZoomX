...
$_lang['setting_zoomx_default_tpl_desc'] = 'Используется когда роутер работает в строгом режиме, и для текущей страницы не найден роут и не найдена страница ошибки.';
...
$_lang['setting_zoomx_routes_mode_desc'] = '0 - роутинг выключен; 1 - смешанный режим (если роут не найден, поиском займётся MODX); 2 - монопольный режим (если роут не найден, то ошибка 404).';
...
$_lang['setting_zoomx_smarty_config_dir_desc'] = 'Полный путь к файлам конфигов Smarty.';
